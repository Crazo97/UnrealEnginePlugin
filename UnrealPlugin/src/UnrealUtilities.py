...
class UnrealUtility:
    ...
    def FindOrCreateBaseMaterial(self):
        ...
        #Connecting the Base Color map to the Base color node in the Blue Print
        ...
        #Connecting the normal map to the normal node in the Blue Print
        ...
        #Connecting the Roughness/Metallic map to the Red, Green, Blue node in the Blue Print
